...
## What about Obsidian Itinerary

This is a fork of the [Obsidian Itinerary](https://github.com/coddingtonbear/obsidian-itinerary) plugin. 

Why? Because I wanted my version to do certain things and have certain features. 

Why publish? Easier to sync on my devices.
